...
export default function Introduction() {
  ...
  const heroFeatures = [
    {
      ...
      description: "Advanced algorithms identify at-risk students before it's too late",
      color: "text-purple-600 dark:text-purple-400"
    },
    {
      icon: Users,
      title: "Unified Student Support",
      description: "Consolidate attendance, grades, and interventions in one platform",
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-indigo-900 via-blue-900 to-purple-900 flex items-center justify-center">
        <div className="text-center">
          <AnimatedLoader />
          <p className="text-white text-xl mt-8 animate-pulse">Initializing MentorAid Platform...</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-gray-900 overflow-x-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="mb-8">
            ...
            <p className="text-lg text-gray-600 dark:text-gray-400 max-w-3xl mx-auto mb-12">
              Harness the power of AI and data analytics to identify, support, and guide at-risk students 
              towards academic success. Transform fragmented data into actionable insights.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
            {heroFeatures.map((feature, index) => (
              ...
              >
                <div className={`inline-flex items-center justify-center w-12 h-12 rounded-xl mb-4 ${feature.color.includes('purple') ? 'bg-purple-100 dark:bg-purple-900/20' : feature.color.includes('blue') ? 'bg-blue-100 dark:bg-blue-900/20' : 'bg-green-100 dark:bg-green-900/20'}`}>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 dark:text-gray-400 max-w-3xl mx-auto">
              Interactive dashboard previews showcasing real-time student analytics, 
              AI-powered interventions, and comprehensive risk management tools.
            </p>
          </div>
          <DashboardShowcase />
        </div>
            ...
            {userRoles.map((user, index) => (
              ...
              >
                <div className="flex items-center mb-6">
                  ...
                  <div className="ml-4">
                    <h3 className="text-xl font-bold text-gray-900 dark:text-white">{user.role}</h3>
                    <p className="text-sm text-gray-600 dark:text-gray-400">{user.access}</p>
                  </div>
                </div>
      ...
      {/* Core Features */}
      <section id="features" className="py-20 bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-gray-800 dark:to-gray-900">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-gray-900 dark:text-white mb-4">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <div className="inline-flex items-center px-4 py-2 bg-gradient-to-r from-purple-100 to-pink-100 dark:from-purple-900/20 dark:to-pink-900/20 rounded-full mb-6">
              ...
              <span className="text-purple-600 dark:text-purple-400 font-medium">Coming Soon</span>
            </div>
            <h2 className="text-4xl font-bold text-gray-900 dark:text-white mb-4">
              Future Enhancements
            </h2>
            <p className="text-xl text-gray-600 dark:text-gray-400">
              Exciting features in development to further enhance student support
            </p>
          </div>
          <FutureEnhancements />
        </div>
      ...
      <section className="py-20 bg-gradient-to-r from-blue-600 to-indigo-600 relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-xl text-blue-100 mb-8">
            Join thousands of educators already using MentorAid to identify, support, 
